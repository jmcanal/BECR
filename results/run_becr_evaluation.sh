...
time python evaluate.py ${ec_output_file} ${recall_file} ${precision_file_10} ${output_file_10} 10

precision_file_25='BECR/top_25_precision.txt'
output_file_25='BECR/25_results'

# evaluate with k=25 for p@k
time python evaluate.py ${ec_output_file} ${recall_file} ${precision_file_25} ${output_file_25} 25